...
def iterative_local_search(distance_matrix, city, algorithm_func, max_no_improv_iters=50):
    """
    ...
    best_distance, best_tour = two_opt_local_search(distance_matrix, city, algorithm_func)
    no_improv_iters = 0
    ...
    while no_improv_iters < max_no_improv_iters:
        ...
        new_distance, new_tour = two_opt_local_search(distance_matrix, city, lambda dm, c: (0, new_tour))
